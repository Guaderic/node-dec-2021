...
router.put('/:id',authMiddleware.checkAccessToken, commonMiddleware.isIdvalid ,userMiddleware.isUserValidForUpdate ,userMiddleware.isUserPresent, userController.updateUser);
